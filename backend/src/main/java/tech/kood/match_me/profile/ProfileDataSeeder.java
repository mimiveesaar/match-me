    ...
    public class ProfileDataSeeder implements CommandLineRunner {
        ...
        private void ensureUserIdColumnExists() {
            try {
                ...
                System.out.println("⚠️ Could not add user_id column: " + e.getMessage());
            }
        }
        ...
        private void seedBodyforms() {
            ...
            for (String b : bodyforms) {
                jdbcTemplate.update("INSERT INTO bodyforms (name) VALUES (?) ON CONFLICT (name) DO NOTHING", b);
            }
        }
        ...
        private void seedHomeplanets() {
            ...
            for (String h : homeplanets) {
                jdbcTemplate.update("INSERT INTO homeplanets (name) VALUES (?) ON CONFLICT (name) DO NOTHING", h);
            }
        }
        ...
        private void seedLookingFor() {
            ...
            for (String l : lookingFor) {
                jdbcTemplate.update("INSERT INTO looking_for (name) VALUES (?) ON CONFLICT (name) DO NOTHING", l);
            }
        }
        ...
        private void seedInterests() {
            ...
            for (String i : interests) {
                jdbcTemplate.update("INSERT INTO interests (name) VALUES (?) ON CONFLICT (name) DO NOTHING", i);
            }
        }
        ...
        private void seedTestProfiles() {
            for (int i = 1; i <= 5; i++) {
                ...
                try {
                    ...
                    System.out.println("⚠️ Failed to insert profile " + username + ": " + e.getMessage());
                }
            }
        }
        ...
        private void verifyData() {
            ...
            for (String table : tables) {
                try {
                    ...
                    System.out.println("⚠️ Cannot count rows in " + table + ": " + e.getMessage());
                }
            }
        }
    }
