...
public class ProfileDTO {
    ...
    public String toString() {
        return "ProfileDTO{" + "name='" + name + '\'' + ", age=" + age + ", homeplanetId="
                + homeplanetId + ", bodyformId=" + bodyformId + ", lookingForId=" + lookingForId
                + ", bio='" + bio + '\'' + ", interestIds=" + interestIds + ", profilePic='"
                + profilePic + '\'' + '}';
    }
}
