...
@Repository
public final class AcceptedConnectionsRepository {
        ...
        public Optional<AcceptedConnectionEntity> findById(UUID id) {
                ...
                try {
                        AcceptedConnectionEntity result = jdbcTemplate.queryForObject(sql,
                                        Map.of("id", id), acceptedConnectionRowMapper);
        ...
        public int deleteBySenderUserId(UUID senderUserId) {
                String sql = "DELETE FROM connections.accepted_connections WHERE sender_user_id = :sender_user_id";
        ...
        public int deleteByTargetUserId(UUID targetUserId) {
                String sql = "DELETE FROM connections.accepted_connections WHERE target_user_id = :target_user_id";
        ...
        /**
         * Deletes all accepted connections. Use with caution as this operation cannot be undone.
        ...
        public int countByUserId(UUID userId) {
                String sql = """
                                ...
                                WHERE sender_user_id = :user_id OR target_user_id = :user_id
                                """;
                Integer count = jdbcTemplate.queryForObject(sql, Map.of("user_id", userId),
                                Integer.class);
                return count != null ? count : 0;
        }
        ...
        public int countBySenderUserId(UUID senderUserId) {
                ...
                Integer count = jdbcTemplate.queryForObject(sql,
                                Map.of("sender_user_id", senderUserId), Integer.class);
                return count != null ? count : 0;
        }
        ...
        public int countByTargetUserId(UUID targetUserId) {
                ...
                Integer count = jdbcTemplate.queryForObject(sql,
                                Map.of("target_user_id", targetUserId), Integer.class);
                return count != null ? count : 0;
        }
        ...
        public List<AcceptedConnectionEntity> findByCreatedAtBetween(Instant startTime,
                ...
                return jdbcTemplate.query(sql,
                                Map.of("start_time", Timestamp.from(startTime), "end_time",
