package tech.kood.match_me.user_management.internal.features.user;
 ...
 * </p>
 */
public final class User extends org.jmolecules.ddd.types.AggregateRoot<UserId> {
    ...
    public static User of(@NotNull UserId id, @NotBlank String username, @NotBlank String email,
            @NotNull HashedPassword hashedPassword, @NotNull Instant createdAt,
            @NotNull Instant updatedAt) {
