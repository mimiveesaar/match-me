...
public class LoginEndpoint {
    ...
    public LoginEndpoint(LoginHandler loginHandler,
            LoginResultsMapper loginResultsMapper) {
    ...
    public LoginResultsDTO loginUser(@RequestBody LoginRequestDTO request) {
        ...
        var internalRequest = new LoginRequest(
                ...
                request.email(),
                request.password(),
                Optional.of(UUID.randomUUID().toString()) // Assuming tracingId is generated here
        );
