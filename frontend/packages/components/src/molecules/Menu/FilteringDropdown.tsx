...
interface FilteringDropdownProps {
    filters: Filters;
    setFilters: (updater: Partial<Filters>) => void; // ← FIXED: Match Zustand type
}
    ...
    return (
        <div className="relative">
            ...
            <RangeSlider
                ...
                onChange={(val) => setFilters({ minAge: val[0], maxAge: val[1] })}
            />
            ...
            <div className="pb-2">
                <div className="flex flex-col items-center">
                    ...
                    <DropdownSelector
                        ...
                        onSelect={(val) => setFilters({ lookingFor: val[0] || "" })}
                        mode='single'
                    />
                    ...
                    <DropdownSelector
                        ...
                        onSelect={(val) => setFilters({ bodyform: val[0] || "" })}
                        mode='single'
                    />
                    ...
                    <DropdownSelector
                        ...
                        onSelect={(val) => setFilters({ interests: val })}
                        mode='multiple'
                    />
                    ...
                    <DropdownSelector
                        ...
                        onSelect={(val) => setFilters({ homeplanet: val[0] || "" })}
                        mode='single'
                    />
                </div>
                ...
                <RangeSlider
                    ...
                    onChange={(val) => setFilters({ maxDistanceLy: val[1] })}
                />
            </div>
        </div>
    );
